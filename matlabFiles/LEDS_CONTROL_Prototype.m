function [data] = LEDS_CONTROL_Prototype(leds,command)
...
if (~strcmpi(command,leds.commands.state_status))
    [data] = NET_ASync_v2(leds.host,leds.portnumber,command,'Ethernet');
else
    [data] = NET_Sync_v2(leds.host,leds.portnumber,command,'Ethernet');
end