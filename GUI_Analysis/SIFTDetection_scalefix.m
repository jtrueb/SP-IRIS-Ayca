function [KPData]= SIFTDetection_scalefix(InputIm, IntensityTh, EdgeTh, MatchFlag, ImScale)
...
UpNormInputIm=UpInputIm;
% temp_floor=2700;
% temp_ceil=3000;
UpNormInputIm(UpNormInputIm>4095)=4095;
% UpNormInputIm=UpNormInputIm-temp_floor;
UpNormInputIm(UpNormInputIm<0)=0;
% UpNormInputIm=UpNormInputIm./(temp_ceil-temp_floor);
% UpNormInputIm(UpNormInputIm>1)=1;

% UpNormInputIm=255*UpNormInputIm;
% figure;
% imshow(UpNormInputIm,[0,255]);
UpNormInputIm=255*UpNormInputIm./4095;
