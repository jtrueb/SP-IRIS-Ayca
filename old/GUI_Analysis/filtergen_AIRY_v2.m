...
%q_x=x_true*pixelSize;
%k_x = (pi*q_x)/(wavelength*fnumberw);
%airy_x=airy_continuous(abs(k_x));
...
% x_mask = repmat(airy_x,kernelSize,1);
% y_mask = repmat(airy_y.',1,kernelSize);
% mask2d = x_mask.*y_mask;
