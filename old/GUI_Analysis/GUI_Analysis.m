...
% Last Modified by GUIDE v2.5 25-Feb-2014 11:04:30
...
handles.compatibility_min=1.2;
handles.software_version='1.4';
...
handles.OuterRad=12;
handles.NA=.75;
handles.backradius=3;
handles.pixelsize=.148;
handles.limits_display=[.5,1,1,1.2];
handles.limits_signal=[.75,1,1.03,1.1];
...
set(handles.edit_EdgeTh,'String',num2str(handles.EdgeTh));
...
function edit_EdgeTh_Callback(hObject, eventdata, handles)
% hObject    handle to edit_EdgeTh (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% Hints: get(hObject,'String') returns contents of edit_EdgeTh as text
%        str2double(get(hObject,'String')) returns contents of edit_EdgeTh as a double
handles.EdgeTh=str2num(get(hObject,'String'));
handles=GUI_Analysis_displayUpdate(handles);
...
function edit_EdgeTh_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_EdgeTh (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
